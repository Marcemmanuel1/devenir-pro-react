...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      ${isScrolled
          ? "backdrop-blur-2xl bg-gradient-to-b from-white/12 to-white/5 border-b border-white/25 shadow-[inset_0_1px_0_rgba(255,255,255,0.4),0_8px_32px_rgba(0,0,0,0.3)]"
          : "bg-transparent"
        }`}
    >
